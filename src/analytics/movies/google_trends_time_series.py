...
misc.line_plot_2Yaxes_without_norm(avengers_trends, avengers_sales, False, "Avengers Time Series")
...
# avengers_sales = pd.DataFrame([num/1000000.0 for num in avengers_list], index=avengers_trends.index.tolist())
# misc.line_plot_2Yaxes_1(avengers_trends, avengers_sales, False, "Black Panther Time Series")
# 
# keywords = ['Star Wars']
...
# avengers_sales = pd.DataFrame([num/1000000.0 for num in avengers_list], index=avengers_trends.index.tolist())
# misc.line_plot_2Yaxes_1(avengers_trends, avengers_sales, False, "Star Wars Time Series")
# 
...
# avengers_sales = pd.DataFrame([num/1000000.0 for num in avengers_list], index=avengers_trends.index.tolist())
# misc.line_plot_2Yaxes_1(avengers_trends, avengers_sales, False, "Jurassic World Time Series")
